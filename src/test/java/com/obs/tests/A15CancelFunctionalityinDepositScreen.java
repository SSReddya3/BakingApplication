...
public class A15CancelFunctionalityinDepositScreen extends BasePage {
	@Test
	public void A14CancelFunctionalityinDepositScreen() throws IOException, InterruptedException {
	...
	//user clciks on cancvel button
	Depositpage.DepositAmountFunctionality();
