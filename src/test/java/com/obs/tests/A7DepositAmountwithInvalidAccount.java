...
public class A7DepositAmountwithInvalidAccount extends BasePage{

	@Test
	public void A7DepositAmountwithInvalidAccount() throws IOException, InterruptedException {
		...
		transactions.clickonDepositandenteramount();
